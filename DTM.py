...
# save at .txt files
        np.savetxt(cwd+'/Results/'+dataname+'Run_'+str(run_num)+'_testmetrics.txt', metrics, delimiter=' ') # save the metrics file
        np.savetxt(cwd+'/Results/'+dataname+'Run_'+str(run_num)+'_testconfu.txt', test_confu, delimiter=' ') # save the test confu mat 
        np.savetxt(cwd+'/Results/'+'Run_'+str(run_num)+dataname+'_testlabel.txt', test_result_vals[1], delimiter=' ') 
        np.savetxt(cwd+'/Results/'+dataname+'Run_'+str(run_num)+'_testpredic.txt', test_result_vals[2], delimiter=' ') 
        ###################################
        # save the cost data
        ...
        plt.savefig(cwd+'/Results/'+dataname+'Run_'+str(run_num)+'_learning_curve.png',dpi=600) # check
        #plt.show()
        ...
        np.savetxt(cwd+'/Results/'+dataname+'Run_'+str(run_num)+ '_trainmetrics.txt', metrics, delimiter=' ') # save the metrics file
        np.savetxt(cwd+'/Results/'+dataname+'Run_'+str(run_num)+'_trainconfu.txt', train_confu, delimiter=' ') 
        np.savetxt(cwd+'/Results/'+'Run_'+str(run_num)+dataname+'_trainlabel.txt', train_result_vals[1], delimiter=' ') 
        np.savetxt(cwd+'/Results/'+dataname+'Run_'+str(run_num)+'_trainpredic.txt', train_result_vals[2], delimiter=' ') 
